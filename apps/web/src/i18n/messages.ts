...
export const fr = {
  ...
  demo: {
    ...
    filmTitle: "Film produit",
    filmLead:
      "Parcours cinéma de la homepage et des dashboards OPJ / entreprise — verre, titres Syne, bleu #0259DD.",
    storyboardTitle: "Storyboard Seedance",
    missingVideo: "La vidéo n’est pas encore générée. Le storyboard ci-dessous décrit le film.",
    generateHint: "Clé Seedance détectée côté serveur. La génération peut prendre quelques minutes.",
    generateMissing: "Ajoutez SEEDANCE_API_KEY ou FAL_KEY dans .env (jamais NEXT_PUBLIC_*).",
    generateCta: "Générer le film Seedance",
    generating: "Génération en cours…",
    generateError: "La génération a échoué. Vérifiez la clé fal.ai et les crédits.",
    watch: "Lancer le film",
    sceneHero: "Homepage — titre Syne",
    sceneHeroBody: "Navbar verre, travelling avant, crème #FBF8F4, mot accent #0259DD.",
    sceneFlow: "Parcours réquisitions",
    sceneFlowBody: "Trois cartes verre : OPJ, entreprise, archive scellée.",
    sceneOpj: "Dashboard OPJ",
    sceneOpjBody: "Liste de réquisitions, public_hash, pastilles de statut, flux 3D discret.",
    sceneEnt: "Dashboard entreprise",
    sceneEntBody: "Pilotage DPO, abonnement, conformité, souveraineté.",
  },
  notFound: {
...
export const en: Messages = {
  ...
  demo: {
    ...
    filmTitle: "Product film",
    filmLead:
      "Cinematic walkthrough of the homepage and OPJ / company dashboards — glass, Syne titles, blue #0259DD.",
    storyboardTitle: "Seedance storyboard",
    missingVideo: "The video is not generated yet. The storyboard below describes the film.",
    generateHint: "A Seedance key is present on the server. Generation may take a few minutes.",
    generateMissing: "Add SEEDANCE_API_KEY or FAL_KEY to .env (never NEXT_PUBLIC_*).",
    generateCta: "Generate the Seedance film",
    generating: "Generating…",
    generateError: "Generation failed. Check the fal.ai key and credits.",
    watch: "Play the film",
    sceneHero: "Homepage — Syne title",
    sceneHeroBody: "Glass navbar, slow push-in, cream #FBF8F4, accent word #0259DD.",
    sceneFlow: "Requisition workflow",
    sceneFlowBody: "Three glass cards: OPJ, company, sealed archive.",
    sceneOpj: "OPJ dashboard",
    sceneOpjBody: "Requisition list, public_hash, status pills, subtle 3D flow.",
    sceneEnt: "Company dashboard",
    sceneEntBody: "DPO ops, billing, compliance, sovereignty.",
  },
  notFound: {
